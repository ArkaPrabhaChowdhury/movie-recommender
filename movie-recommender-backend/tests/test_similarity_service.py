...
class SimilarityServiceTests(unittest.TestCase):
    ...
    def test_story_and_genre_match_beats_popularity(self):
        ...
        self.assertEqual(rank_similar_content(self.source, [weak, strong])[0]["id"], 2)
    ...
    def test_filters_source_duplicates_missing_posters_and_unavailable_titles(self):
        candidates = [
            ...
            {"id": 4, "content_type": "movie", "poster": "good.jpg", "streaming": {"platform_found": True}},
            {"id": 4, "content_type": "movie", "poster": "duplicate.jpg", "streaming": {"platform_found": True}},
        ]
